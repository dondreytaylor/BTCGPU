...
- Detached signatures will then be committed to the [bithereum-detached-sigs](https://github.com/BTCGPU/bithereum-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
